...
/**
 * it calculates the center point (latitude and longitude) based on the list of coordinates
 * @param {array} coordinates array of objects { latitude, longitude }
 * @return 
 */

export const getCenterLocation = (coordinates: []): { latitude: number, longitude: number } => {
  ...
  coordinates.forEach((item: { latitude: number, longitude: number }) => {
